...
import { FetchPlatform } from '../../../components/utils/Helpers';


class ListPlatform extends React.Component {
    ...
    componentDidMount() {
        ...
        (async () => {
            let response = await FetchPlatform();
            this.setState({
                data: response
            });
        })();
    ...
    render() {
...

                    {
                        ...
                        <td>
                            ...
                            <a
                                onClick={
                                    () => {
                                        window.location.assign('edit-platform/' + element.id)
                                    }
                                }
        ...
        let pageContent = <div id='user_table' className='row'>
            <div className="col-sm-12 mb-3 mt-3">
                <h3 className="float-left">Platforms List</h3>
                <a style={{ "color": "white" }} type="button" href="add-platform" className="btn btn-info float-right">Add Platform</a>
            </div>
            <div className='col-sm-12 col-md-12'>
                <div className="form-group mb-2">
                    <input type="text"
                        ...
                        className="form-control" placeholder="search platform"></input>
                </div>
...
if (document.getElementById('list_platform')) {
    ReactDOM.render(<ListPlatform />, document.getElementById('list_platform'));
}